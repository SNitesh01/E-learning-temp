  ...
  return (
    <>
      ...
      <Row className="row-cols-1 row-cols-sm-2 row-cols-xl-3 row-cols-xxl-5 g-4">
        <Col>
          <Card>
            <img src="/img/product/small/product-1.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-2.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-3.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-4.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-5.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-6.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
                  Apple Cake Recipe
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-7.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-8.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-9.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
        ...
        <Col>
          <Card>
            <img src="/img/product/small/product-10.jpg" className="card-img-top sh-25" alt="card image" />
            <Card.Body>
              <NavLink to="/quiz/detail" className="body-link d-block sh-6 mb-2 h5 heading lh-1-5">
                <Clamp tag="span" clamp="2">
