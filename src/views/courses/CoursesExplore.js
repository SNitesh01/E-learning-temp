  ...
  return (
    <>
      ...
      <Row className="row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-5">
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-1.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-2.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-3.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-4.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
      ...
      <Row className="row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-5">
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-5.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-6.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-7.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Img src="/img/product/small/product-8.jpg" className="card-img-top sh-22" alt="card image" />
            <Card.Body>
              <h5 className="heading mb-0">
                <NavLink to="/courses/detail" className="body-link stretched-link">
      ...
      <Row className="g-3 row-cols-1 row-cols-xl-2 row-cols-xxl-4 mb-5">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body>
              <div className="text-center">
                <img src="/img/illustration/icon-experiment.png" className="theme-filter" alt="performance" />
                <div className="d-flex flex-column sh-5">
                  <NavLink to="/paths/list" className="heading stretched-link">
                    Cooking Chemistry
                  </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body>
              <div className="text-center">
                <img src="/img/illustration/icon-storage.png" className="theme-filter" alt="performance" />
                <div className="d-flex flex-column sh-5">
                  <NavLink to="/paths/list" className="heading stretched-link">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body>
              <div className="text-center">
                <img src="/img/illustration/icon-accounts.png" className="theme-filter" alt="performance" />
                <div className="d-flex flex-column sh-5">
                  <NavLink to="/paths/list" className="heading stretched-link">
                    Local Food Master
                  </NavLink>
      ...
      <Row className="g-3">
        <Col lg="6" className="position-relative">
          ...
          <Card className="sh-24 hover-img-scale-up">
            <img src="/img/banner/cta-horizontal-short-1.jpg" className="card-img h-100 scale" alt="card image" />
        ...
        <Col lg="6" className="position-relative">
          ...
          <Card className="sh-24 hover-img-scale-up">
            <img src="/img/banner/cta-horizontal-short-2.jpg" className="card-img h-100 scale" alt="card image" />
            <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
