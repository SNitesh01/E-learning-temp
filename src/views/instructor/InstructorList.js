      ...
      <Row className="row-cols-1 row-cols-sm-2 row-cols-xl-3 row-cols-xxl-4 g-3">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-5.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Zayn Hartley
              </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-6.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Esperanza Lodge
              </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-7.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Kathryn Mengel
              </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-8.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Eneida Farzana
              </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-9.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Fabian Ciera
              </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img src="/img/profile/profile-10.jpg" className="img-fluid rounded-xl" alt="thumb" />
              </div>
              <NavLink to="/instructor/detail" className="mb-3 body-link">
                Ryland Darrin
              </NavLink>
