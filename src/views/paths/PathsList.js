      ...
      <Row className="g-3 mb-5">
          ...
          <Card>
            <Row className="g-0 h-auto sh-sm-23">
              <Col xs="12" sm="auto" className="h-100 p-5 pb-0 pb-lg-5 text-center">
                <img src="/img/illustration/icon-launch.png" alt="path" className="card-img w-auto theme-filter" />
              </Col>
        ...
        <Col xl="6">
          <Card>
            <Row className="g-0 h-auto sh-sm-23">
              <Col xs="12" sm="auto" className="h-100 p-5 pb-0 pb-lg-5 text-center">
                <img src="/img/illustration/icon-experiment.png" alt="path" className="card-img w-auto theme-filter" />
              </Col>
              <Col xs="12" className="col-sm p-0 h-100">
                <Card.Body className="ps-lg-0">
                  <div className="d-flex flex-row justify-content-between mb-2">
