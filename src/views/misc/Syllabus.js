              ...
              <div className="d-flex flex-row flex-wrap mb-n2">
                <div className="sw-30 me-2 mb-2">
                  <Row className="g-0 rounded-sm sh-8 border">
                    <Col xs="auto">
                      <img src="/img/product/small/product-5.jpg" className="card-img card-img-horizontal rounded-sm-start sw-10" alt="product image 1" />
                    </Col>
                ...
                <div className="sw-30 me-2 mb-2">
                  <Row className="g-0 rounded-sm sh-8 border">
                    <Col xs="auto">
                      <img src="/img/product/small/product-4.jpg" className="card-img card-img-horizontal rounded-sm-start sw-10" alt="product image 1" />
                    </Col>
                    <Col className="rounded-sm-end d-flex flex-column justify-content-center px-3">
                      <div className="d-flex justify-content-between">
                        <p className="mb-0 clamp-line" data-line="1">
