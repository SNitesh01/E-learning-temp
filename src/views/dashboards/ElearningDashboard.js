      ...
      <Row>
        ...
        <Col xl="6" className="mb-5">
            ...
            <Row className="g-0 sh-14">
              <Col xs="auto" className="position-relative">
                <NavLink to="/courses/detail">
                  <img src="/img/product/small/product-1.jpg" alt="alternate text" className="card-img card-img-horizontal sw-14 sw-lg-18" />
          ...
          <Card className="mb-2">
            <Row className="g-0 sh-14">
              <Col xs="auto" className="position-relative">
                <NavLink to="/courses/detail">
                  <img src="/img/product/small/product-2.jpg" alt="alternate text" className="card-img card-img-horizontal sw-14 sw-lg-18" />
                  <Button variant="foreground" size="sm" className="btn-icon-only px-3 position-absolute absolute-center opacity-75 pe-none">
                    <CsLineIcons icon="play" size="16" fill="var(--primary)" />
                  </Button>
                </NavLink>
          ...
          <Card>
            <Row className="g-0 sh-14">
              <Col xs="auto" className="position-relative">
                <NavLink to="/courses/detail">
                  <img src="/img/product/small/product-3.jpg" alt="alternate text" className="card-img card-img-horizontal sw-14 sw-lg-18" />
                  <Button variant="foreground" size="sm" className="btn-icon-only px-3 position-absolute absolute-center opacity-75 pe-none">
                    <CsLineIcons icon="play" size="16" fill="var(--primary)" />
                  </Button>
                </NavLink>
        ...
        <Col xl="6" className="mb-5">
          ...
          <Card className="sh-50 sh-md-40 h-xl-100-card hover-img-scale-up">
            <img src="/img/banner/cta-standard-3.jpg" className="card-img h-100 scale position-absolute" alt="card image" />
          ...
          <Card className="sh-40 h-xl-100-card">
            <Card.Body className="d-flex align-items-center justify-content-center h-100">
              <div className="text-center">
                <img src="/img/illustration/icon-analytics.png" className="theme-filter mb-3" alt="launch" />
